                    ...
                    <div class="table-responsive">
                        ...
                        <div class="container border border-dark">
                            ...
                            <div class="row row-cols-4 border-top border-dark text-center">
                                ...
                                <div class="cols">{{$Transaction->car_name}}</div>
                                ...
                                <div class="cols">{{$Transaction->mitra_name}}</div>
                            ...
                            <div class="row row-cols-4 border-top border-dark text-center">
                                ...
                                <div class="cols">{{$Transaction->promo_code}}</div>
                            </div>
                            ...
                            <div class="row row-cols-4 text-center">
                                ...
                                <div class="cols border-top border-dark fw-bold">{{$Transaction->payment_total}}</div>
                            </div>
                            <div class="row row-cols-4 text-center">
